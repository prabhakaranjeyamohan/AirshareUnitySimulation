...
namespace Google.Maps.Scripts {
    ...
    public sealed class DynamicMapsService : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                RenderingStyles = Defaults.DefaultGameObjectOptions;
            }
        ...
        private bool VerifyParameters()
        {
            ...
            if (Ground == null)
            {
                Debug.LogError(ErrorMessageGenerator.MissingParameter(this, Ground, "Ground"));
            ...
            if (Camera.main == null)
            {
                Debug.LogError(ErrorMessageGenerator.NullMainCamera(this));
